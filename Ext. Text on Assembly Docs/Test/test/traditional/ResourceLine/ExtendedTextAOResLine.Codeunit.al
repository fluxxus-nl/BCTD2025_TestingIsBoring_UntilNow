codeunit 76454 "Extended Text AO Res. Line FLX"
{
    ...
    begin
        ...
        ResourceNo := CreateResourceWithExtendedText(DisableAutomaticExtTexts(), GetAssemblyDocumentType(), true);
    ...
    begin
        ...
        ResourceNo := CreateResourceWithExtendedText(EnableAutomaticExtTexts(), GetAssemblyDocumentType(), true);
        // [GIVEN] Assembly order
        AssemblyDocNo := CreateAssemblyOrder();
    ...
    begin
        ...
        // [GIVEN] Resource with "Automatic Ext. Texts" disabled and extended text enabled for assembly order
        ResourceNo[1] := CreateResourceWithExtendedText(DisableAutomaticExtTexts(), GetAssemblyDocumentType(), true);
    ...
    var
        AssemblyLine: Record "Assembly Line";
    begin
        LibraryExtTextAssDoc.VerifyExtendedTextLinesAreAddedToAssemblyDocument(AssemblyLine."Document Type"::Order, AssemblyDocNo, AssemblyLine.Type::Resource, ResourceNo, 1);
    end;
