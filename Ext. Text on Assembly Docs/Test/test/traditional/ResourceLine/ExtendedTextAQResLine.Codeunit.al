codeunit 76455 "Extended Text AQ Res. Line FLX"
{
    ...
    var
        AssemblyLine: Record "Assembly Line";
    begin
        LibraryExtTextAssDoc.VerifyExtendedTextLinesAreAddedToAssemblyDocument(AssemblyLine."Document Type"::Quote, AssemblyDocNo, AssemblyLine.Type::Resource, ResourceNo, 1);
    end;
