codeunit 76456 "Extend. Text BAO Res. Line FLX"
{
    ...
    begin
        ...
        ResourceNo := CreateResourceWithExtendedText(DisableAutomaticExtTexts(), GetAssemblyDocumenType(), true);
    ...
    begin
        ...
        ResourceNo := CreateResourceWithExtendedText(EnableAutomaticExtTexts(), GetAssemblyDocumenType(), true);
        // [GIVEN] Blanket assembly order
        AssemblyDocNo := CreateBlanketAssemblyOrder();
    ...
    begin
        ...
        ResourceNo := CreateResourceWithExtendedText(EnableAutomaticExtTexts(), "Assembly Document Type"::None, false);
        // [GIVEN] Blanket assembly order
        AssemblyDocNo := CreateBlanketAssemblyOrder();
    ...
    begin
        ...
        ResourceNo := CreateResourceWithExtendedText(DisableAutomaticExtTexts(), "Assembly Document Type"::None, false);
        // [GIVEN] Blanket assembly order with resource line
        AssemblyDocNo := CreateBlanketAssemblyOrderWithResourceLine(ResourceNo);
    ...
    begin
        ...
        // [GIVEN] Resource with "Automatic Ext. Texts" disabled and extended text enabled for blanket assembly order
        ResourceNo[1] := CreateResourceWithExtendedText(DisableAutomaticExtTexts(), GetAssemblyDocumenType(), true);
    ...
    var
        AssemblyLine: Record "Assembly Line";
    begin
        LibraryExtTextAssDoc.VerifyExtendedTextLinesAreAddedToAssemblyDocument(AssemblyLine."Document Type"::"Blanket Order", AssemblyDocNo, AssemblyLine.Type::Resource, ResourceNo, 1);
    end;
    ...
    local procedure GetAssemblyDocumenType(): Enum "Assembly Document Type"
    begin
