codeunit 76495 "Library - Sales 2 FLX"
{
    ...
    var
        ...
        LibraryERM: Codeunit "Library - ERM 2 FLX";
    ...
    //     LibrarySales: Codeunit "Library - Sales FLX";
    // begin
    ...
    procedure CreateSalesCommentLine(var SalesCommentLine: Record "Sales Comment Line"; DocumentType: Enum "Sales Document Type"; No: Code[20];
...
#if not CLEAN25
    procedure CreateSalesPrice(var SalesPrice: Record "Sales Price"; ItemNo: Code[20]; SalesType: Enum "Sales Price Type"; SalesCode: Code[20];
                                                                                                      StartingDate: Date;
    ...
    procedure CreateCustomerDocumentLayout(CustomerNo: Code[20]; UsageValue: Enum "Report Selection Usage"; ReportID: Integer;
